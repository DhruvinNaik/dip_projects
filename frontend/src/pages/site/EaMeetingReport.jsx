...
export default function EaMeetingReport() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(err.message || "Could not load EM report");
      setRows([]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="smt-page">
      <div className="smt-head">
        <div>
          <h1 className="smt-title">EM Meeting Attendance</h1>
          <p className="smt-sub">
      ...
      {loading ? (
        ...
        <div className="smt-empty">No EM attendance in this range.</div>
      ) : (
