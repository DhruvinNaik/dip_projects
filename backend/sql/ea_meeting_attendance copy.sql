-- EM Meeting attendance (Monday weekly meeting).
...
create table if not exists public.ea_meeting_attendance (
  ...
  -- Weekly plan / Excel uploads for EM meeting
...
comment on table public.ea_meeting_attendance is
  'Monday EM meeting QR attendance + plan uploads. Isolated from clock-in attendance.';
